            ...
            {(userData.role === "STAFF" ||
              ...
              <>
                <Route element={<StaffLayout />}>
                  ...
                  <Route path="staff-buy-back" element={<StaffBuyBack />} />
                </Route>
                <Route element={<StaffSidebarLayout />}>
                  <Route path="staff-bill" element={<StaffBill />} />
            ...
            {(userData.role === "MANAGER" || userData.role === "ADMIN") && (
              <>
                <Route element={<ManagerLayout />}>
                  <Route path="managerPromotion" element={<Promotion />} />
                  <Route path="manager-stall" element={<ManagerStall />} />
                  <Route
                ...
                <Route element={<ManagerSidebarLayout />}>
                  ...
                  <Route path="manager-bill" element={<StaffBill />} />
                  <Route path="manager-revenue" element={<Revenue />} />
                  <Route path="manager-gem" element={<ManagerGem />} />
                </Route>
              </>
            )}
          </>
